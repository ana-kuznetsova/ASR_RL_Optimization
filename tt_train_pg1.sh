...
echo "Eval 2"
python /N/u/anakuzne/Carbonate/curr_learning/DeepSpeech/evaluate.py --test_files='/N/slate/anakuzne/tatar/clips/test.csv' --alphabet_config_path='/N/slate/anakuzne/tatar/tt_alphabet.txt' --test_batch_size 32 --checkpoint_dir='/N/slate/anakuzne/tt_ckpt_automated_curr/1/' --load='best' --test_output_file='/N/u/anakuzne/Carbonate/curr_learning/automated_curr/loss_after.json' --report_count 4700